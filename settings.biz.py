...
from settings_common.settings_dbs import DATABASES_BIGDATA_OFFLINE as DATABASES
...
# from settings_common.settings_online_redis import ONLINE_REDIS as REDIS
